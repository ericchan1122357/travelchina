    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* 快速链接 */}
          <div>
            <h3 className="text-lg font-semibold mb-4">{t('footerPrivacy')}</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>{t('footer.email')}: contact@chinatravel.com</li>
              <li>{t('footer.phone')}: +86 123 4567 8901</li>
              <li>{t('footer.address')}: {t('footer.addressDetail')}</li>
            </ul>
          </div>

          {/* 社交媒体 */}
          <div>
            <h3 className="text-lg font-semibold mb-4">{t('footerTerms')}</h3>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>© {new Date().getFullYear()} {t('nav.logo')}. {t('nav.copyright')}.</p>
        </div>
      </div>
    </footer>
  );

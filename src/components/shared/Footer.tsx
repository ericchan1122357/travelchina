  ...
  const getTranslatedString = (key: string) => {
    const translations: Record<string, Record<string, string>> = {
      'brand': {
        ...
        'de': 'China Freies Reisen',
        'es': 'Viajes Libres a China',
        'ja': '中国自由旅行',
        'ko': '중국 자유 여행',
      ...
      'tagline': {
        'zh': '您的自由行规划助手',
        'en': 'Your Free Travel Planning Assistant',
        'fr': 'Votre assistant de voyage libre',
        'de': 'Ihr Assistent für freies Reisen',
        'es': 'Su asistente de viaje libre',
        'ja': 'あなたの自由旅行プランニングアシスタント',
        'ko': '당신의 자유 여행 계획 도우미',
        'ru': 'Ваш помощник в свободном путешествии',
      },
      'quickLinks': {
        'zh': '快速链接',
        'en': 'Quick Links',

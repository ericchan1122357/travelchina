...
export const guilinContent: Record<Language, DestinationContent> = {
  ...
  ja: { title: '桂林', subtitle: '', sections: [] },
  ko: { title: '구이린', subtitle: '', sections: [] },
  fr: { title: 'Guilin', subtitle: '', sections: [] },
  de: { title: 'Guilin', subtitle: '', sections: [] },
  es: { title: 'Guilin', subtitle: '', sections: [] },
  ru: { title: 'Гуйлинь', subtitle: '', sections: [] }
};
...
const translations: Record<Language, any> = {
  en: {
    ...
    requestsPlaceholder:
      "Please tell us any special requirements or expectations...",
  ...
  fr: {
    ...
    createPlan: "Créez Votre Plan de Viaje Personalisé",
    ...
    accommodationTypes: [
      ...
      "Hôtels de Luxe",
      "Maisons d'Hôtes Caractéristiques",
    ...
    diningPreferences: [
      ...
      "Cuisine Familiale",
      "Cuisine de Rue",
      "Végétarien/Régime Spécial",
    ],
    additionalRequests: "Demandes Supplémentaires",
    requestsPlaceholder:
      "Veuillez nous indiquer vos exigences ou attentes particulières...",
  ...
  de: {
    ...
    diningPreferences: [
      ...
      "Hausmannskost",
      "Straßenessen",
      "Vegetarisch/Spezielle Ernährung",
    ],
    additionalRequests: "Zusätzliche Anfragen",
    requestsPlaceholder:
      "Bitte teilen Sie uns besondere Anforderungen oder Erwartungen mit...",
  ...
  ja: {
    ...
    budgetRanges: [
      "エコノミー (¥50,000以下)",
      "スタンダード (¥50,000-¥100,000)",
      "プレミアム (¥100,000-¥150,000)",
      "ラグジュアリー (¥150,000+)",
    ],
  ...
  ko: {
    ...
    budgetRanges: [
      "이코노미 (₩500,000 이하)",
      "스탠다드 (₩500,000-₩1,000,000)",
      "프리미엄 (₩1,000,000-₩1,500,000)",
      "럭셔리 (₩1,500,000+)",
    ],
  ...
  es: {
    ...
    diningPreferences: [
      ...
      "Cocina Casera",
      "Comida Callejera",
      "Vegetariano/Dieta Especial",
    ],
    additionalRequests: "Solicitudes Adicionales",
    requestsPlaceholder:
      "Por favor, díganos cualquier requisito o expectativa especial...",
  ...
  ru: {
    ...
    budgetRanges: [
      "Эконом (До ₽30,000)",
      "Стандарт (₽30,000-₽60,000)",
      "Премиум (₽60,000-₽90,000)",
      "Люкс (₽90,000+)",
    ],
    ...
    diningPreferences: [
      ...
      "Домашняя Кухня",
      "Уличная Еда",
      "Вегетарианская/Специальная Диета",
    ],
    additionalRequests: "Дополнительные Запросы",
    requestsPlaceholder:
      "Пожалуйста, расскажите нам о любых особых требованиях или ожиданиях...",
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-5xl mx-auto">
          ...
          <section className="mb-10">
            <h3 className="text-xl font-semibold text-gray-700 mb-4 flex items-center">
              <span className="bg-china-red text-white rounded-full w-8 h-8 inline-flex items-center justify-center mr-2">
                1
              </span>
              {t.destinations}
            </h3>

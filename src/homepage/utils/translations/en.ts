...
export const enTranslations: TranslationValue = {
  ...
  'value.2.title': 'Professional Guidance',
  'value.2.desc': 'Big data guidance from 70 million travel enthusiasts',
  'value.3.title': 'Worry-free Experience',
  'value.3.desc': 'Explore the beauty of China without barriers',

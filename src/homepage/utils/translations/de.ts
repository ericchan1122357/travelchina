...
export const deTranslations: TranslationValue = {
  ...
  'value.2.desc': 'Big-Data-Empfehlungen von 70 Millionen Reiseliebhabern',
  ...
  'story.1.description': 'Ein Einblick in das alte Peking',
  'story.1.destination': 'Peking',
  'story.2.title': 'Der zauberhafte Berg Huang',
  'story.2.description': 'Meine Reise zum berühmten Gelben Berg',
  'story.2.destination': 'Anhui',
  'story.3.title': 'Chengdu: Mehr als nur Pandas',
  'story.3.description': 'Die vielseitige Hauptstadt von Sichuan erleben',
  'story.3.destination': 'Chengdu',

  'guide.1.title': 'Peking in 3 Tagen',
  'guide.1.description': 'Die Highlights der Hauptstadt',
  'guide.1.category': 'Stadt',
  'guide.2.title': 'Shanghai Shopping Guide',
  'guide.2.description': 'Die besten Einkaufsmöglichkeiten',
  'guide.2.category': 'Shopping',
  'guide.3.title': 'Sichuan Küche erkunden',
  'guide.3.description': 'Eine Reise durch die Aromen Sichuans',
  'guide.3.category': 'Essen',

  'destination.1.name': 'Peking',
  'destination.1.description': 'Die historische Hauptstadt',
  'destination.1.activities.hiking': 'Wandern auf der Großen Mauer',
  'destination.1.activities.culture': 'Kulturelle Erkundung',
  'destination.1.activities.food': 'Kulinarische Entdeckungen',
  'destination.2.name': 'Shanghai',
  'destination.2.description': 'Die moderne Metropole',
  'destination.2.activities.shopping': 'Shopping-Paradies',
